        ...
        <nav className="flex items-center gap-2">
          ...
          >
            ...
            <MenuItem className="p-0 hover:bg-transparent">
              <Link
                to="/" 
                className="text-gray-300 flex flex-1 items-center gap-4 py-2 px-4 hover:bg-secondary-900 
             ...
             <MenuItem className="p-0 hover:bg-transparent">
              ...
              >
                  ...
                  <div className="text-sm flex flex-col">
                    ...
                    <p className="text-gray-500 text-xs">A Jorge le gusta tu pub...</p>
                  </div>
              </Link>
            </MenuItem> 
            <MenuItem className="p-0 hover:bg-transparent">
            ...
            <hr className="my-6 border-gray-500" />
            <MenuItem className="p-0 hover:bg-current flex justify-center cursor-default">
              <Link to="/" className="text-gray-400 text-sm hover:text-primary transition-colors">Todas las Notificaciones</Link>
            </MenuItem>
          </Menu>
          <Menu 
            menuButton={
              <MenuButton className="flex items-center gap-x-2 hover:bg-secondary-100 p-2
          ...
          >
            ...
            <MenuItem className="p-0 hover:bg-transparent">
              <Link 
                ...
                items-center gap-x-4 py-2 px-6 flex-1"
              >
                <RiLogoutCircleRLine  /> Cerrar secion
              </Link>
            </MenuItem>
          </Menu>
        </nav>
